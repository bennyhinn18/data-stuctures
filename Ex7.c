...
1)Create: 2)Insert: 3)Delete: 4)Print: 5)Quit:
Enter Your Choice:4
Preorder sequence: 7(Bf=-1)4(Bf=0)12(Bf=1)9(Bf=0)
...
Inorder sequence: 4(Bf=0)9(Bf=0)12(Bf=0)
1)Create: 2)Insert: 3)Delete: 4)Print: 5)Quit:
Enter Your Choice:5
RESULT:
Thus, the program to implement the operations in AVL Tree in C was executed successfully.*/
